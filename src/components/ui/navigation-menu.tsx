...
const components: { title: string; href: string; description: string }[] = [
  ...
  },
  {
    title: "Study Plans",
    href: "/study-plans",
    description: "Personalized schedules and progress tracking.",
  },
  {
    title: "Spaced Repetition",
    href: "/spaced-learning",
    description: "TikTok-style quick revision videos and gamified learning.",
  },
  {
    title: "Content Tools",
    href: "/content-tools",
    description: "AI-powered summarization and audio generation.",
  },
]
